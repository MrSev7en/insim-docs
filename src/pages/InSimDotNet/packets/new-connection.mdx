...
> **Tipo:** byte | número\
> **Descrição:** ID do úsuario

### UName

> **Tipo:** string | texto\
> **Descrição:** Username do usuário
...
> **Descrição:** Se o usuário está utilizando a senha de administrador
...
> **Tipo:** bool | comparação\
> **Descrição:** Se o usuário está conectado localmente ou remotamente
